    (6, 19): 175, (6, 20): 208,
    (6, 21): 192, (6, 22): 240, (6, 23): 236, (6, 24): 159, (6, 25): 221, (6, 26): 243, (6, 27): 235, (6, 28): 206,
    (6, 29): 238, (6, 30): 156
}
...
# 新增的直线距离参数
L_p = {1:180, 2:428.92, 3:140.83, 4:200.45, 5:20.32}  # 港口 p 到 p+1 的直线距离（海里）
...
for n in range(max_iter):
    ...
    for omega in Omega:
        ...
        # 新增变量
        sin_theta = {}  # sin(theta) 辅助变量
        cos_theta = {}  # cos(theta) 辅助变量
        ...
        for p in P_:
            # 定义角度变量 theta[p]
            model.addConstr(theta[p] >= 0.01, name=f"ThetaMin_{p}")
            model.addConstr(theta[p] <= (np.pi / 2) - 0.01, name=f"ThetaMax_{p}")

            # 定义 sin_theta[p] 和 cos_theta[p]
            sin_theta[p] = model.addVar(vtype=GRB.CONTINUOUS, lb=0, ub=1, name=f"sin_theta_{p}")
            cos_theta[p] = model.addVar(vtype=GRB.CONTINUOUS, lb=0, ub=1, name=f"cos_theta_{p}")

            # 定义 tan_theta[p] 和 cot_theta[p]
            tan_theta[p] = model.addVar(vtype=GRB.CONTINUOUS, lb=0, name=f"tan_theta_{p}")
            cot_theta[p] = model.addVar(vtype=GRB.CONTINUOUS, lb=0, name=f"cot_theta_{p}")

            # 使用 Gurobi 的一般约束来定义三角函数
            model.addGenConstrSin(theta[p], sin_theta[p], options="FuncPieces=-2", name=f"SinTheta_{p}")
            model.addGenConstrCos(theta[p], cos_theta[p], options="FuncPieces=-2", name=f"CosTheta_{p}")

            # 计算总的 d_p_total
            d_p_total = d_p[p] + d_p.get(p + 1, 0)

            # 添加约束：d_p_total * sin_theta[p] + L_p[p] * cos_theta[p] <= l_p[p]
            s = model.addVar(vtype=GRB.CONTINUOUS, name=f"s_{p}")
            model.addConstr(s == d_p_total * sin_theta[p] + L_p[p] * cos_theta[p], name=f"DistanceExpr_{p}")
            model.addConstr(s <= l_p[p], name=f"DistanceConstraint_{p}")

            # 将 s[p] 纳入目标函数进行最小化
            # 您可以根据需要调整目标函数的权重
            model.setObjective(model.getObjective() + s, GRB.MINIMIZE)

            # 更新航线距离计算
            # 计算 ECA 和非 ECA 区域的航行距离
            # 当 y[p] = 1 时，表示绕行
            model.addConstr(l_e[p] == d_p_total / sin_theta[p], name=f"DistanceECA_{p}")
            model.addConstr(l_ne[p] == L_p[p] - (d_p[p] + d_p[p+1]) * cot_theta[p], name=f"DistanceNECA_{p}")

            # 当 y[p] = 0 时，直接航线，不绕行
            model.addConstr(l_e[p] <= M_big * y[p], name=f"DirectRouteLE_{p}")
            model.addConstr(l_ne[p] <= M_big * y[p], name=f"DirectRouteLNE_{p}")
        ...
        if model.status == GRB.OPTIMAL or model.status == GRB.TIME_LIMIT:
            ...
            for p in P:
                ...
                # 选择的时间窗
                selected_z = [k for k in K if scenario_solutions[omega]['z'][p, k] > 0.5]
                print(f"  选择的时间窗口: {selected_z[0] if selected_z else '未选择'}")
                # 进港时间
