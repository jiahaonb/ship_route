...
b = {
    (1,1):4, (1,2):8, (1,3):18, (1,4):20,
    (2,1):4, (2,2):8, (2,3):18, (2,4):20,
    (3,1):4, (3,2):8, (3,3):18, (3,4):20,
    (4,1):4, (4,2):10, (4,3):18, (4,4):20,
    (5,1):4, (5,2):10, (5,3):16, (5,4):20,
    (6,1):5, (6,2):11, (6,3):18, (6,4):20
}
...
for n in range(max_iter):
    ...
    for omega in Omega:
        ...
        model.addConstrs((t_eta_mod[p] <= 24 for p in P), name="ETA_Modulo_Max")
        ...
        for p in P:
            if p == 1:
                ...
                for k in K:
                    ...
                    model.addConstr(
                        t_port_entry[p] >= 24 * n_days_port_entry[p, k] + a[p, k] - M_big * (1 - z[p, k]),
                        name=f"PortEntryStartWindow_{p}_{k}"
                    )
                    model.addConstr(
                        t_port_entry[p] <= 24 * n_days_port_entry[p, k] + b[p, k] + M_big * (1 - z[p, k]),
